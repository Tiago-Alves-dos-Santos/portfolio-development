<template>
    <div class="flex justify-center bg-white shadow-md">
        <div class="container flex justify-between ">
            ...
            <div class="relative top-[10px] w-[30px] h-[30px] rounded-full flex justify-center flex-col items-center bg-black
            cursor-pointer">
            ...
            <div class="flex">
                ...
                <a href="" class="nav-active py-4 px-4 hover:bg-primary-900 hover:text-white">SOBRE</a>
